...
from formats_hub import png, jpg
import shutil
app = Flask(__name__)
    ...
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            if request.form.get('convertto') == 'png':
                filepath = png.to_png(file, f'{app.config["UPLOAD_FOLDER"]}/{output_name}.png')
            elif request.form.get('convertto') == 'jpg':
                filepath = jpg.to_jpg(file, f'{app.config["UPLOAD_FOLDER"]}/{output_name}.jpg')
